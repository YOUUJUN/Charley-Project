    ...
    methods: {
        ...
        createDots(bmap) {
            let cache = [
                ...
                [116.032873, 38.553378],
                [116.032873, 37.553378],
            ];
            var markers = [];
            var pt = null;
            ...
            _clusterMarker.onclick = (e) => {
                console.log('e', e);
                e.preventDefault();
                return false;
            }

            _clusterMarker.addEventListener("click", function(e) {  
                console.log('e2', e)
              });
        },
